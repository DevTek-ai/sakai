...
public class PortalSiteHelperImpl implements PortalSiteHelper {
    ...
    private Map<String, Object> getSiteMap(Site site, String currentSiteId, String userId, boolean pinned, boolean hidden, boolean includePages, List<Map<String, Object>> pinnedSites) {
        ...
        if (site.getPropertiesEdit() != null) {
            siteMap.put("properties", site.getPropertiesEdit());
        }
//		siteMap.put(SITE_DEPARTMENT_TYPE, site.getPropertiesEdit().get(SITE_DEPARTMENT_TYPE));
        if (includePages) {
    ...
    public Map<String, Object> getContextSitesWithPages(HttpServletRequest req, String currentSiteId, String toolContextPath, boolean loggedIn) {
        ...
        if (loggedIn) {
            ...
            contextSites.put("out", System.out);
    ...
    public Map<String, Object> pageListToMap(HttpServletRequest req, boolean loggedIn, Site site,
        ...
        for (SitePage p : getPermittedPagesInOrder(site)) {
            ...
            if (doPages || p.isPopUp()) {
                ...
                if (!serverConfigurationService.getBoolean("portal.addmoretools.enable", legacyAddMoreToolsPropertyValue))
                    addMoreToolsUrl = null;
